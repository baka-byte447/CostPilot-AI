...
class AzureCostController:
    """
    Pulls real cost data from Azure Cost Management API.
    Works with your student $100 credits — shows exactly
    how much each resource type is consuming.
    """
    ...
    def get_cost_by_service(self, days: int = 7) -> list:
        """Returns cost broken down by Azure service for the last N days."""
        from azure.mgmt.costmanagement.models import (

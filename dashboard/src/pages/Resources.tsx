    ...
    <div className="p-10 fade-in">
      <header className="mb-8 flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-400 mt-1.5 text-sm">AWS Mock (LocalStack) · Azure Real Cloud</p>
        </div>
        <div className="flex gap-2">
          <span className="px-3 py-1 bg-primary/10 text-primary text-[10px] font-bold rounded-full border border-primary/20 uppercase">Mock AWS</span>
          <span className="px-3 py-1 bg-emerald-400/10 text-emerald-400 text-[10px] font-bold rounded-full border border-emerald-400/20 uppercase">Real Azure</span>
        </div>
      </header>
